import 'package:mindbull/models/tag.dart';
...
class Post {
  ...
  String?
      audioId; // This field is named 'audio' in the response and can be null
  String?
      audioLink; // This field is named 'audio' in the response and can be null
...
/*  print('Post json: $json');
    ...
    return Post(
      ...
      userId: json['user_id_backend_post'] != null
          ? json['user_id_backend_post']['id'] as String?
          : null,
      username: json['user_id_backend_post'] != null
          ? json['user_id_backend_post']['username'] as String?
          : null,
      profilePictureUrl: json['user_id_backend_post'] != null
          ? json['user_id_backend_post']['profile_picture'] as String?
          : null,
      totalLikes: json['total_likes'] as int?,
      content: json['post_description'] as String?,
      audioLink: json['audio_link'] != null
          ? (json['audio']['audio_link'] as String?)
          : null,
      videoLink: videoLink,
      // No ratingAverage field in the response
      // If 'id' field of 'audio' is an integer, handle it appropriately
      audioId: json['audio_file'] != null
          ? (json['audio']['id'] as int?)?.toString()
          : null,
      imageUrl: imageUrl,
      compositionId: json['composition_fk'] != null
          ? json['composition_fk']['composition_uuid'] as String
          : null,
