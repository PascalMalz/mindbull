...
import 'package:mindbull/api/api_feed_service.dart';
...
class _LazyLoadingFeedState extends State<LazyLoadingFeed> {
  ...
  void initState() {
    ...
    scrollNotifier =
        Provider.of<ScrollPositionNotifier>(context, listen: false);
    ...
    _scrollController.addListener(() {
      ...
      print(
          '_LazyLoadingFeedState initState Scroll position stored! = ${_scrollController.offset}');
    });
  ...
  void _loadAndSetScrollPosition() async {
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      if (_scrollController.hasClients && mounted) {
        _scrollController.animateTo(scrollNotifier.position,
                      ...
                      children: [
                        Positioned(
                          ...
                          child: Opacity(
                            opacity: 0.5,
                            child: Image.asset(
                                'assets/background_sky.jpg'), // Replace this
                          ),
                        ),
                        ...
                        Positioned(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "Erstellt: ${formatDateString(posts[index]['created_at'])}" ??
                                    'Default Content',
                                style: const TextStyle(color: Colors.white),
                              ),
                            ],
                          ...
                          child: Opacity(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                    posts[index]['rating_average'].toString() ??
                                        '',
                                    style: const TextStyle(color: Colors.white),
