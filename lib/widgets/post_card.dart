...
import 'package:mindbull/widgets/seek_new_try/audio_player_composition_widget.dart';
import 'package:mindbull/widgets/seek_new_try/audio_player_single_audio_widget.dart';
import 'package:mindbull/widgets/video_player_widget.dart';
...
class _PostCardState extends State<PostCard> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget compositionTreeWidget = const SizedBox.shrink();
    Widget videoPlayerWidget = const SizedBox.shrink();
    ...
    if (hasVideoLink) {
      ...
      if (toggle_composition_tree) {
        ...
        compositionTreeWidget = const SizedBox.shrink();
      ...
      playerWidget =
          const CircularProgressIndicator(); // Or some other placeholder
      compositionTreeWidget = const SizedBox.shrink();
    }
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  const SizedBox(
                      width: 35), // Adjusted according to your layout
                ],
              ),
            ),
