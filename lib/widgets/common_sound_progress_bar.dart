        ...
        StreamBuilder<Duration>(
          ...
          builder: (context, snapshot) {
            ...
            if ((currentPosition.inMilliseconds +
                    widget.lengthOfPreviousAudioFiles.toInt()) <=
                widget.duration.inMilliseconds) {
              globalPosition = Duration(
                  milliseconds: currentPosition.inMilliseconds +
                      widget.lengthOfPreviousAudioFiles.toInt());
            }
            if (bulletUpdateCounter == 0) {
              if (!isDragged) {
                _bulletPosition = (currentProgress +
                    (widget.lengthOfPreviousAudioFiles /
                        widget.duration.inMilliseconds));
                  ...
                  Positioned(
                    ...
                    child: GestureDetector(
                      onHorizontalDragUpdate: (details) {
                        ...
                        final newBulletPosition = _bulletPosition +
                            details.primaryDelta! / widget.width;
