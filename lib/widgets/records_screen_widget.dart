...
// Proceed with deletion
    ...
    for (var key in metadataBox.keys) {
      ...
      if (existingAudioFile != null &&
          existingAudioFile.title == audioFile.title) {
        matchingKey = key;
        break;
      }
    }
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return _buildAudioListItem(
            audioFiles[index]); // Replace with your actual widget
      },
    );
  }
        ...
        Expanded(
          child: Container(
            ...
            child: Row(
              ...
              children: [
                Expanded(
                  child: audioFile.title.length >
                          15 // Customize based on your desired length
                      ? Marquee(
