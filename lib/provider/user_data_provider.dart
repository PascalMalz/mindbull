...
class UserDataProvider with ChangeNotifier {
  User? _currentUser;
  final Map<String, User?> _otherUsers = {}; // Cache other users' data
  ...
  Future<void> loadUserData() async {
    ...
    try {
      final userData = await fetchUserProfile(accessToken);
  ...
  Future<void> loadOtherUserData(String userId) async {
    print('loadOtherUserData start');
      ...
      try {
        ...
        final userData = await fetchOtherUserProfile(accessToken, userId);
