...
import 'package:mindbull/api/token_refresher.dart';
...
class TokenHandler {
   ...
   tokenRefresher.initiateTokenRefreshTimers();*/
    ...
    try {
      Workmanager().initialize(
        ...
        isInDebugMode:
            true, // Debug mode to show notification whenever a background task is triggered
      );
      ...
      try {
        ...
        print(
            'TokenHandler: tokenRefresher init initiateTokenRefreshTimers  failed');
      }
    } catch (err) {
  ...
  bool isAccessTokenAvailableAndValid() {
    return _accessToken
        .isNotEmpty; // You can implement more validation logic here
  }
