  ...
  Future<List<Post>> fetchPosts({
    ...
    try {
      ...
      if (characteristics != null) {
        queryParameters['characteristics'] = characteristics;
      }
      print(
          'ApiFeedAudioImageService fetchPosts queryParameters $queryParameters');
      ...
      print(
          "Raw response data: ${response.data}"); // Log the entire raw response
