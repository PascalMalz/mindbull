...
class _AfterJoinState extends State<AfterJoin> {
  ...
  Future<void> _saveComposition() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Composition saved successfully')));
  }
      ...
      body: Column(
        children: [
          ...
          ElevatedButton(
            ...
            child: const Text("Print Composition Details"),
          ),
          ElevatedButton(
