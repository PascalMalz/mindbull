...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    username = userDataProvider.currentUser?.username ??
        'N/A'; // 'N/A' is a fallback in case the username is null
        ...
        children: [
          ...
          Container(
            color: const Color.fromRGBO(0, 0, 0,
                0.37), // Adjust the alpha (0.5) for desired transparency
          ),
          Padding(
            ...
            child: GridView.count(
              ...
              children: [
                FunctionCard(
                  ...
                  description:
                      "Listen to composition of sounds / affirmations to: \n• Be more relaxed\n• Be more focused\n• Sleep better\n• Enjoy the moment",
                ...
                FunctionCard(
                  ...
                  description:
                      "Listen to composition of sounds and affirmations to: \n•Be more relaxed\n•Be more focused•\nSleep better•Enjoy the moment",
        ...
        child: Card(
          ...
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(
                0), // Set the border radius to 0 for squared corners
          ),
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  child: Container(
                    ...
                    height: 50,
                    decoration: BoxDecoration(
                      color: const Color(0x00041d2a).withOpacity(0.5),
