...
class _RatingTableState extends State<RatingTable> {
  ...
  void updateLocalStateFromProvider() {
    ...
    setState(() {
      ...
      isLoading =
          false; // Ensure to set isLoading to false once the data is loaded
  ...
  void _setRating(
      String category, PersonalGrowthCharacteristic characteristic, int value) {
                                    ...
                                    trailing: Row(
                                      ...
                                      children: List.generate(5, (starIndex) {
                                        return IconButton(
                                          ...
                                          onPressed: () {
                                            _setRating(category, characteristic,
                                                starIndex + 1);
                                          },
                                        );
                                      }),
