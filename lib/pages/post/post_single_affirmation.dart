...
//todo make the descriptionController work again when you come back to the screen
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Post Single Affirmations'),
      ),
      ...
      if (imageFilePath != null && audioFilePath != null) {
        ...
        if (result == null) {
          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
              content: Text("Post with media uploaded successfully")));
        } else {
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              ...
              child: const Text('From App Storage'),
            ),
          ],
        );
      },
