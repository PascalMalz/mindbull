...
import '../services/thumbnail_selector.txt';


import 'dart:typed_data';

class MediaEditorPage extends StatefulWidget {
  const MediaEditorPage({super.key});
...
class _MediaEditorPageState extends State<MediaEditorPage> {
  ...
  void _editOrRemoveTrack(int index) {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text('Edit or Remove Track'),
          content: const Text('Would you like to edit or remove this track?'),
          actions: <Widget>[
            TextButton(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Create Composition"),
        actions: [
        ...
        children: [
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                if (mediaItem.thumbnail is Future<Uint8List?>?) {
                  ...
                  thumbnailFuture = Future.value(mediaItem.thumbnail);
                }
                    ...
                    child: FutureBuilder<Uint8List?>(
                      ...
                      builder: (BuildContext context, AsyncSnapshot<Uint8List?> snapshot) {
                        if (snapshot.connectionState == ConnectionState.done && snapshot.data != null) {
                          return ListTile(
                            contentPadding: const EdgeInsets.symmetric(vertical: 10.0, horizontal: 15.0), // Add padding inside ListTile for a bigger look
                      ...
                      leading: GestureDetector(
                        ...
                        child: SizedBox(
                          ...
                          child: mediaItem.thumbnail != null
                              ...
                              : const Icon(Icons.image, size: 60.0),  // Increase the size of the default image icon
                        ),
                      ),
                      title: Text("Video Item $index"),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                const Text("Add New Media Track", style: TextStyle(fontSize: 20),),
                IconButton(
                  icon: const Icon(Icons.add_circle_outline, size: 30, color: Colors.deepPurple,),
                  onPressed: _addMedia,
                )
              ],
            ),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                IconButton(icon: const Icon(Icons.photo_filter), onPressed: () {}),
                IconButton(icon: const Icon(Icons.adjust), onPressed: () {}),
              ],
            ),
          ),
        ],
